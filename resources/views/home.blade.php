...
@foreach ($jobs as $job) 
    <div class="lg:flex lg:items-center lg:justify-between block px-4 py-6 border border-gray-200 rounded-lg space-y-4 ">
      <div class="min-w-0 flex-1 ">
        <h2 class="text-2xl/7 font-bold text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">{{$job['job_name']}}</h2>
      <div class="mt-1 flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap sm:space-x-6 space-y-4">
  ...
  <div class="mt-5 flex lg:mt-0 lg:ml-4 ">
    ...
    <span classjon="ml-3 hidden sm:block">
      <a href="{{ route('job.show', ['job' => $job->id]) }}" class="inline-flex items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-xs ring-1 ring-gray-300 ring-inset hover:bg-gray-50">
